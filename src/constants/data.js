...
export const GALLERY_TINTS = [
  ...
  `linear-gradient(135deg, #E8D5E8 0%, #C9A8C9 100%)`,
  `linear-gradient(135deg, #F0E6EF 0%, #DBBFDB 100%)`,
  `linear-gradient(135deg, #E2CEE2 0%, #C5A0C5 100%)`,
  `linear-gradient(135deg, #EDD9EA 0%, #C9A8C9 100%)`,
  `linear-gradient(135deg, #F5ECFF 0%, #D4A8D4 100%)`,
